        ...
        <div class="container">
            ...
            <form action="/employee" method="get" id="seachEmployeeForm" role="form">
                ...
                <div class="form-group col-xs-5">
                    <input type="text" name="employeeName" id="employeeName" class="form-control" required="true" placeholder="Type the First Name or Last Name of the Customer"/>                    
                </div>
                        ...
                        <table  class="table table-striped">
                            ...
                            <c:forEach var="employee" items="${employeeList}">
                                ...
                                <tr class="${classSucess}">
                                    ...
                                    <td>${employee.age}</td>   
                                    <td><a href="#" id="remove" 
                                           onclick="document.getElementById('action').value = 'remove';document.getElementById('id').value = '${employee.id}';
